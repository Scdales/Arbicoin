...
class BtceSetup():
 __api_key	= '2ZWSQ5PP-C04OOZRX-7GVQPJ77-9ZXHXD3Y-VKO1M7J6';
 __api_secret	= '7010b9e56ace5ea2f37255f1d0485909f810d0fa695af1be6a4971479aab73db';
 __nonce_v	= 1;
 ...
 def WithdrawCoin(self, tcoinName, tamount, taddress):
  params = {
   "coinName"	: tcoinName,
   "amount"	: tamount,
   "address"	: taddress}
  return self.__api_call('WithdrawCoin', params)
